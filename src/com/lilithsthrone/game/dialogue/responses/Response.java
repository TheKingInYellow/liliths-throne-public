...
public class Response {
	...
	public boolean isAvailable(){
		...
		if(sexActionType!=null) {
			corruptionOrFetishReqs = isBaseCorruptionWithinRange() || isAvailableFromFetishes() || (corruptionBypass==null && fetishesRequired==null);
		} else {
			if(corruptionBypass==null) {
				corruptionOrFetishReqs = isAvailableFromFetishes() || fetishesRequired==null;
			} else {
				corruptionOrFetishReqs = isBaseCorruptionWithinRange() || isAvailableFromFetishes();
			}
		}
